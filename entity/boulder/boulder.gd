...
const BASE_EXPLOSION_RADIUS: float = 150.0 # Radius of the explosion effect when boulder lands
...
func update_type():
	can_enter_turret = true # All boulders can enter turrets
	match _type:
		Type.BASIC:
